...
public class GetPraiaFromDB extends AsyncTask<Void, Void, Praia> {
  ...
  public GetPraiaFromDB(Context ctx, TextView txtAdress, TextView txtMsg, TextView txtTemp, TextView txtHumidade, TextView txtPrecipitacao, TextView txtNuvens, TextView txtPressao, TextView txtRaiosUV, TextView txtRajadas, TextView txtVento, ImageView imgTemp, RelativeLayout load) {
    this.ctx = ctx;
